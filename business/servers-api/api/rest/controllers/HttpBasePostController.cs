...
public class HttpBasePostController : ControllerBase
{
	[ApiController]
	[Route("api/http-post")]
	public class HttpPostController : ControllerBase
	{
		private readonly ILogger<HttpPostController> _logger;
		...
		public HttpPostController(
			ILogger<HttpPostController> logger,
